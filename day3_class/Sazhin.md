...
# 1.3 Почему количество документов меньше количества вхождений? Ответ: В одном документе больше вероятность того, что оно и то же слово будет применяться неоднократно.
```
...
глаг, нп, св, повел, действ, 2л, ед, disamb
