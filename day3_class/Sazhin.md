...
# 1.3 Почему количество документов меньше количества вхождений? Ответ: В некоторых документах есть несколько вхождений одного и того же слова.
```
...
```
# 2.1 К какой части речи принадлежит форма _подыми_ в первом предложении выдачи? Запишите ее помету: глагол.
```
...
```
# 3.4 Ответ: Лексико-грамматический поиск возможен только по лемме слова, а словосочетание `баба с возу` состоит из нескольких слов.
```
